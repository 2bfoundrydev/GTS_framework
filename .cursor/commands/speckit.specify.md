...
2. **Check for existing branches before creating new one**:
   ...
   - Example: `{SCRIPT} --json --number 5 --short-name "user-auth" "Add user authentication"`
...
6. **Specification Quality Validation**: After writing the initial spec, validate it against quality criteria and create a checklist at `FEATURE_DIR/checklists/requirements.md`.
